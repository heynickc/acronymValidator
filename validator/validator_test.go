...
var testPairsIsValid = []testPair{
	...
	{"OOGLE", []string{"Google", "Search", "Engine"}, true},
...
var testPairsIsValidCharCount = []testPair{
	{"GIZTK3", []string{"GISi", "Zombie", "Tracker", "3000"}, true},
	{"GZT3", []string{"GISi", "Zombie", "Tracker", "3000"}, true},
	{"GISEE0", []string{"GISi", "Zombie", "Tracker", "3000"}, true},
	{"GZT3k", []string{"GISi", "Zombie", "Tracker", "3000"}, true},
	{"GZ", []string{"GISi", "Zombie", "Tracker", "3000"}, false},
	{"G", []string{"GISi", "Zombie", "Tracker", "3000"}, false},
	{"BL", []string{"GISi", "Zombie", "Tracker", "3000"}, false},
}

var testPairsIsValidCharOrder = []testPair{
	{"GIZTK3", []string{"GISi", "Zombie", "Tracker", "3000"}, true},
	{"GZT3", []string{"GISi", "Zombie", "Tracker", "3000"}, true},
	{"GISEE0", []string{"GISi", "Zombie", "Tracker", "3000"}, true},
	{"GZT3k", []string{"GISi", "Zombie", "Tracker", "3000"}, false},
	{"GZT", []string{"GISi", "Zombie", "Tracker", "3000"}, true},
	{"GZTK", []string{"GISi", "Zombie", "Tracker", "3000"}, true},
	{"BLAH", []string{"GISi", "Zombie", "Tracker", "3000"}, false},
}
...
func TestIsValidCharCount(t *testing.T) {
	for _, pair := range testPairsIsValidCharCount {
		result := IsValidCharCount(pair.acronym, pair.productName)
		if result != pair.out {
			t.Errorf("Expected %v to be %v, but got %v", pair.acronym, pair.out, result)
		}
	}
...
func TestIsValidContainment(t *testing.T) {
	for _, pair := range testPairsIsValidCharCount {
		result := IsValidContainment(pair.acronym, pair.productName)
		if result != pair.out {
			t.Errorf("Expected %v to be %v, but got %v", pair.acronym, pair.out, result)
		}
	}
...
func TestIsValidCharOrder(t *testing.T) {
	for _, pair := range testPairsIsValidCharOrder {
		result := IsValidCharOrder(pair.acronym, pair.productName)
		if result != pair.out {
			t.Errorf("Expected %v to be %v, but got %v", pair.acronym, pair.out, result)
		}
	}
